<!-- filepath: g:\projects\restaurant-system\resources\views\items\create.blade.php -->
@extends('layouts.app')
            ...
            <div class="row">
               ...
               <div class="col-md-8">
                  <div class="mb-4">
                     ...
                     <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Enter item name">
                     @error('name')
                  ...
                  <div class="mb-4">
                     ...
                     <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Enter a detailed description of the menu item">{{ old('description') }}</textarea>
                     @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                     @enderror
                     ...
                     <div class="card-body">
                        <div class="mb-4">
                           ...
                           <div class="image-preview-container text-center mb-3">
                              <img id="imagePreview" src="{{ asset('images/placeholder-food.png') }}" class="img-fluid rounded" style="max-height: 200px; width: auto;">
                           </div>
                        ...
                        <div class="form-check form-switch">
                           <input type="checkbox" class="form-check-input" id="available" name="available" {{ old('available', true) ? 'checked' : '' }}>
